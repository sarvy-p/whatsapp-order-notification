...
const runtimePackage = 'whatsapp-order-notification'
const actionUrl = `https://${namespace}.${hostname}/api/v1/web/${runtimePackage}/publish-order-event`
